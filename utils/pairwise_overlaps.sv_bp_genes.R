...
gene_overlaps= get_reciprocal_overlap_pairs_start_end(svs_gr,gene_properties,reciprocal_overlap = 0,svtype_matching = FALSE)
...
write.table(gene_overlaps,sv_bp_gene_overlaps_path,quote = F,sep = "\t",row.names=F,col.names = T)
