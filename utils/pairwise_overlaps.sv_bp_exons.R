...
exon_overlaps= get_reciprocal_overlap_pairs_start_end(svs_gr,exon_properties,reciprocal_overlap = 0,svtype_matching = FALSE)
...
write.table(exon_overlaps,sv_bp_exon_overlaps_path,quote = F,sep = "\t",row.names=F,col.names = T)
